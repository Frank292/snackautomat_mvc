...
abstract class IRegisterController {
  ...
  /// The Product the user aims for, until the price is payed. Resets to null if
  ...
  factory IRegisterController() = MainController;
}
