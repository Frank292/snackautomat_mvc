...
void main() {
  ...
  test('RC hat Standardwerte nach Erstellung', () {
    ...
    expect(rc.message1, 'Bitte Wählen sie ein Snack');
  });
  ...
  test('RC nimmt im Admin-Mode Münzen an und erreicht Zielzustand', () {
    final rc = IRegisterController();
    rc.adminMode();
    rc.insertCoin(10);
    rc.insertCoin(10);
  ...
  test('RC, ausreichende Bezahlung, aber Wechselgeld nicht möglich', () {
    ...
    expect(eq(rc.payout, []), true);
    expect(rc.message1, 'Bitte passend(er) bezahlen');
  });
}
